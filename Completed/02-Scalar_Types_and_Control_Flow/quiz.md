...
Answer: Name is String, age is intiger and whether passed is bool type. 
...
---
Answer: It will print 55 as Python treats '5' and '5' as strings.
...
Answer: The not operator flips a Boolean value: True becomes False, and False becomes True.
...
---
Answer: or requires at least one condition to be True for the whole expression to return True.
...
Answer: Comparing floats with == is risky because floating-point values can contain tiny rounding errors. For example, 0.1 + 0.2 == 0.3 returns False even though the numbers appear equal. Using a tolerance (such as abs(a - b) < 0.0001) is usually safer.
...
---
Answer: With score = 150, 0 <= score <= 100 evaluates to true because C++ first evaluates 0 <= score, gets true (which becomes 1), and then checks whether 1 <= 100, which is also true.
## ✅ Answer Key
